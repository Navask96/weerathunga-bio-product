...
const Header = () => {
  ...
  return (
    ...
    <nav className={`bg-white rounded border-spacing-2 border-gray-200 dark:bg-gray-900 ${
      isScrolled ? 'fixed top-0 left-0 right-0 shadow-lg z-50 bg-opacity-100' :  'rounded-lg'
    }`} >
